...
url_list = {}
api_key = "240f6d4bdec8c54b6d8da109591ca5120ae55a72"
...
def search_movies(query):
    try:
        ...
        print(f"An error occurred during movie search: {e}")
        return []
...
def get_movie(query):
    try:
        ...
        print(f"An error occurred while retrieving movie details: {e}")
        return {}
